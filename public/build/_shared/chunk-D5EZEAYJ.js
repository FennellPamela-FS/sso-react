...
// node_modules/@clerk/shared/dist/esm/chunk-CX34SAMA.js
function Ce() {
...
function Fe(e) {
  return `${se.test(e) ? W : w}${btoa(`${e}$`)}`;
}
function Ue(e) {
  if (e = e || "", !ie(e))
    return null;
  let t = e.startsWith(w) ? "production" : "development", r = k(e.split("_")[2]);
  return r.endsWith("$") ? (r = r.slice(0, -1), { instanceType: t, frontendApi: r }) : null;
}
function ie(e) {
  e = e || "";
  let t = e.startsWith(w) || e.startsWith(W), r = k(e.split("_")[2] || "").endsWith("$");
  return t && r;
}
function Ge(e) {
...
var he, V, K, X, j, Y, g, h, x, I, P, C, ve, z, J, Re, Se, Z, Q, q, ee, te, _, L, M, re, ne, T, k, w, W, se, ae, A, le, je, O, ce, B, et, tt, R, F, ue, S, dt, de, me, fe, bt;
var init_chunk_CX34SAMA = __esm({
  "node_modules/@clerk/shared/dist/esm/chunk-CX34SAMA.js"() {
    he = (e) => {
      if (e.length == 0)
        return "";
    ...
    I = (e) => typeof e != "string" && "r" in e;
    P = (e) => typeof e != "string" && "h" in e;
    C = (e) => e === "transparent";
    ve = (e) => typeof e != "string" && e.a != null && e.a < 1;
    z = /[hsla()]/g;
    J = /[rgba()]/g;
    Re = (e) => e === "transparent" ? { h: 0, s: 0, l: 0, a: 0 } : g(e) ? te(e) : x(e) ? M(e) : h(e) ? _(e) : null;
    Se = (e) => (e = e.trim(), g(e) ? e.startsWith("#") ? e : `#${e}` : h(e) ? L(e) : x(e) ? M(e) : C(e) ? e : "");
    Z = (e) => typeof e == "string" && (g(e) || C(e)) ? e : I(e) ? q(e) : P(e) ? ee(e) : "";
    Q = (e) => {
      e = e.replace("#", "");
    ...
    _ = (e) => {
      ...
      let u = { h: Math.round(l), s: c, l: p }, f = t.a;
      return f != null && (u.a = f), u;
    };
    L = (e) => {
    ...
    ne = y(re, { path: "/" });
    T = ne;
    k = (e) => typeof atob < "u" && typeof atob == "function" ? atob(e) : typeof Buffer < "u" ? new Buffer(e, "base64").toString() : e;
    w = "pk_live_";
    W = "pk_test_";
...
`;
    ...
    S = () => {
      let e = 0, t = () => e++, r = /* @__PURE__ */ new Map(), n = (a, m) => a?.postMessage(m), s = (a) => {
        r.get(a.data.id)?.();
      }, o = F(R, { name: "clerk-timers" });
      if (o?.addEventListener("message", s), !o)
        return ue();
      let i = () => {
        o || (o = F(R, { name: "clerk-timers" }), o?.addEventListener("message", s));
      };
      return { setTimeout: (a, m) => {
        i();
        let d = t();
        return r.set(d, a), n(o, { type: "setTimeout", id: d, ms: m }), d;
      }, setInterval: (a, m) => {
        i();
        let d = t();
        return r.set(d, a), n(o, { type: "setInterval", id: d, ms: m }), d;
      }, clearTimeout: (a) => {
...
__export(esm_exports2, {
  ...
  snakeToCamel: () => $,
  stringToHslaColor: () => Re,
  stringToSameTypeColor: () => Se,
  titleize: () => Ze,
  toSentence: () => he,
  useClerkInstanceContext: () => G,
  useClientContext: () => Lr,
  useOrganization: () => Dr,
  useOrganizationContext: () => Pe2,
  useOrganizationList: () => Wr,
  useOrganizations: () => Kr,
  useSessionContext: () => Se2,
  useUserContext: () => Ie
});
function pr({ packageName: e, customMessages: i }) {
  let t = e, n = { ...tt2, ...i };
  function a(r, o) {
    if (!o)
      return `${t}: ${r}`;
    let f = r, d = r.matchAll(/{{([a-zA-Z0-9-_]+)}}/g);
    for (let s of d) {
  ...
  return { setPackageName({ packageName: r }) {
    return typeof r == "string" && (t = r), this;
  }, setMessages({ customMessages: r }) {
    return Object.assign(n, r || {}), this;
  }, throwInvalidPublishableKeyError(r) {
    throw new Error(a(n.InvalidPublishableKeyErrorMessage, r));
  }, throwInvalidFrontendApiError(r) {
    throw new Error(a(n.InvalidFrontendApiErrorMessage, r));
  }, throwMissingPublishableKeyError() {
    throw new Error(a(n.MissingPublishableKeyErrorMessage));
  } };
}
function rt(e, i) {
  if (!e)
...
function Fe2(e, i, t, n) {
  ...
  return new (t || (t = Promise))(function(r, o) {
    ...
    function s(l) {
      l.done ? r(l.value) : a(l.value).then(f, d);
    }
...
function We2(e, i) {
  ...
  function d(s) {
    ...
    for (; t; )
      try {
        if (n = 1, a && (r = s[0] & 2 ? a.return : s[0] ? a.throw || ((r = a.return) && r.call(a), 0) : a.next) && !(r = r.call(a, s[1])).done)
          return r;
...
function Ze2(e, i, t, n) {
  return [e, i.id, t?.id, t?.updatedAt, n.offset, n.limit].filter(Boolean).join("-");
}
function It(e) {
  return e.map((i) => ({ membership: i, organization: i.organization }));
}
var import_react, import_react2, tt2, H2, xr, G, Er, Ie, wr, Lr, Mr, Se2, Tr, Pe2, M2, h2, Q2, b2, k2, S2, Ce2, ye, ut, ft2, ie2, lt, te2, he2, ct, _e, Re2, pe, dt2, be, vt, gt, mt, ht, pt2, bt2, ae2, Ot, X2, ve2, Ae, Ne, _2, Ke, $e, He, ee2, zt, Oe2, Ge2, ke, qe, Ct, je2, Je2, yt, Ye, Be, ze, Rt, xt, Et, wt, Lt, Ue2, ge, Mt, Pr, xe, Dr, Wr, Kr;
var init_esm2 = __esm({
  "node_modules/@clerk/shared/dist/esm/index.js"() {
    init_chunk_CX34SAMA();
    import_react = __toESM(require_react());
    import_react2 = __toESM(require_react());
    tt2 = Object.freeze({ InvalidFrontendApiErrorMessage: "The frontendApi passed to Clerk is invalid. You can get your Frontend API key at https://dashboard.clerk.dev/last-active?path=api-keys. (key={{key}})", InvalidPublishableKeyErrorMessage: "The publishableKey passed to Clerk is invalid. You can get your Publishable key at https://dashboard.clerk.dev/last-active?path=api-keys. (key={{key}})", MissingPublishableKeyErrorMessage: "Missing publishableKey. You can get your key at https://dashboard.clerk.dev/last-active?path=api-keys." });
    H2 = (e, i) => {
      let { assertCtxFn: t = rt } = i || {}, n = import_react.default.createContext(void 0);
      return n.displayName = e, [n, () => {
        let o = import_react.default.useContext(n);
    ...
    [xr, G] = H2("ClerkInstanceContext");
    [Er, Ie] = H2("UserContext");
    [wr, Lr] = H2("ClientContext");
    [Mr, Se2] = H2("SessionContext");
    [Tr, Pe2] = H2("OrganizationContext");
    M2 = function() {
    };
    h2 = M2();
    Q2 = Object;
    ...
    te2 = function(e) {
      ...
      if (Q2(e) === e && !n && t != RegExp) {
        ...
        if (t == Q2) {
          a = "#";
          for (var o = Q2.keys(e).sort(); !b2(r = o.pop()); )
            b2(e[r]) || (a += r + ":" + te2(e[r]) + ",");
          ie2.set(e, a);
        }
      } else
    ...
    dt2 = Re2 ? document.addEventListener.bind(document) : M2;
    be = _e && window.removeEventListener ? window.removeEventListener.bind(window) : M2;
    vt = Re2 ? document.removeEventListener.bind(document) : M2;
    gt = function() {
      var e = Re2 && document.visibilityState;
      return b2(e) || e !== "hidden";
    };
    mt = function(e) {
      return dt2("visibilitychange", e), pe("focus", e), function() {
    ...
    ve2 = typeof navigator < "u" && navigator.connection;
    Ae = !ae2 && ve2 && (["slow-2g", "2g"].includes(ve2.effectiveType) || ve2.saveData);
    Ne = function(e) {
      if (k2(e))
        try {
          e = e();
    ...
    $e = 1;
    He = 2;
    ee2 = function(e, i, t, n, a, r, o) {
      o === void 0 && (o = true);
      var f = _2.get(e), d = f[0], s = f[1], l = f[3], v2 = d[i], c = s[i];
      if (o && c)
        for (var y2 = 0; y2 < c.length; ++y2)
          c[y2](t, n, a);
      return r && (delete l[i], v2 && v2[0]) ? v2[0](He).then(function() {
        return e.get(i);
      }) : e.get(i);
    };
    zt = 0;
    ...
    Ge2 = function() {
      for (var e = [], i = 0; i < arguments.length; i++)
        e[i] = arguments[i];
      return Fe2(void 0, void 0, void 0, function() {
        var t, n, a, r, o, f, d, s, l, v2, c, y2, N, O2, g2, u, q2, U, T2, E, D;
        return We2(this, function(P2) {
          switch (P2.label) {
            case 0:
              if (t = e[0], n = e[1], a = e[2], r = e[3], o = typeof r == "boolean" ? { revalidate: r } : r || {}, f = b2(o.populateCache) ? true : o.populateCache, d = o.revalidate !== false, s = o.rollbackOnError !== false, l = o.optimisticData, v2 = Ne(n), c = v2[0], y2 = v2[2], !c)
                return [2];
              if (N = _2.get(t), O2 = N[2], e.length < 3)
                return [2, ee2(t, c, t.get(c), h2, h2, d, true)];
              if (g2 = a, q2 = Oe2(), O2[c] = [q2, 0], U = !b2(l), T2 = t.get(c), U && (E = k2(l) ? l(T2) : l, t.set(c, E), ee2(t, c, E)), k2(g2))
                try {
                  g2 = g2(t.get(c));
                } catch (V2) {
                  u = V2;
                }
              return g2 && k2(g2.then) ? [4, g2.catch(function(V2) {
                u = V2;
              })] : [3, 2];
            case 1:
              if (g2 = P2.sent(), q2 !== O2[c][0]) {
                if (u)
                  throw u;
                return [2, g2];
              } else
                u && U && s && (f = true, g2 = T2, t.set(c, T2));
              P2.label = 2;
            case 2:
              return f && (u || (k2(f) && (g2 = f(g2, T2)), t.set(c, g2)), t.set(y2, S2(t.get(y2), { error: u }))), O2[c][1] = Oe2(), [4, ee2(t, c, g2, u, h2, d, !!f)];
            case 3:
              if (D = P2.sent(), u)
                throw u;
              return [2, f ? D : g2];
    ...
    qe = function(e, i) {
      if (!_2.has(e)) {
        var t = S2(bt2, i), n = {}, a = Ge2.bind(h2, e), r = M2;
        if (_2.set(e, [n, {}, {}, {}, a]), !ae2) {
          var o = t.initFocus(setTimeout.bind(h2, ke.bind(h2, n, Ke))), f = t.initReconnect(setTimeout.bind(h2, ke.bind(h2, n, $e)));
          r = function() {
            o && o(), f && f(), _2.delete(e);
          };
        }
    ...
    Ct = function(e, i, t, n, a) {
      var r = t.errorRetryCount, o = a.retryCount, f = ~~((Math.random() + 0.5) * (1 << (o < 8 ? o : 8))) * t.errorRetryInterval;
      !b2(r) && o > r || setTimeout(n, f, a);
    };
    je2 = qe(/* @__PURE__ */ new Map());
    Je2 = je2[0];
    yt = je2[1];
    Ye = S2({ onLoadingSlow: M2, onSuccess: M2, onError: M2, onErrorRetry: Ct, onDiscarded: M2, revalidateOnFocus: true, revalidateOnReconnect: true, revalidateIfStale: true, shouldRetryOnError: true, errorRetryInterval: Ae ? 1e4 : 5e3, focusThrottleInterval: 5 * 1e3, dedupingInterval: 2 * 1e3, loadingTimeout: Ae ? 5e3 : 3e3, compare: function(e, i) {
      return te2(e) == te2(i);
    }, isPaused: function() {
      return false;
    ...
    Be = function(e, i) {
      var t = S2(e, i);
      if (i) {
        var n = e.use, a = e.fallback, r = i.use, o = i.fallback;
        n && r && (t.use = n.concat(r)), a && o && (t.fallback = S2(a, o));
      }
      return t;
    };
    ze = (0, import_react2.createContext)({});
    Rt = function(e) {
      var i = e.value, t = Be((0, import_react2.useContext)(ze), i), n = i && i.provider, a = (0, import_react2.useState)(function() {
        return n ? qe(n(t.cache || Je2), i) : h2;
      })[0];
    ...
    xt = function(e, i) {
      var t = (0, import_react2.useState)({})[1], n = (0, import_react2.useRef)(e), a = (0, import_react2.useRef)({ data: false, error: false, isValidating: false }), r = (0, import_react2.useCallback)(function(o) {
        var f = false, d = n.current;
        for (var s in o) {
          var l = s;
          d[l] !== o[l] && (d[l] = o[l], a.current[l] && (f = true));
        }
        f && !i.current && t({});
      }, []);
      return X2(function() {
    ...
    Lt = function(e) {
      return function() {
        for (var t = [], n = 0; n < arguments.length; n++)
          t[n] = arguments[n];
        var a = wt(), r = Et(t), o = r[0], f = r[1], d = r[2], s = Be(a, d), l = e, v2 = s.use;
        if (v2)
          for (var c = v2.length; c-- > 0; )
            l = v2[c](l);
    ...
    ge = { dedupe: true };
    Mt = function(e, i, t) {
      var n = t.cache, a = t.compare, r = t.fallbackData, o = t.suspense, f = t.revalidateOnMount, d = t.refreshInterval, s = t.refreshWhenHidden, l = t.refreshWhenOffline, v2 = _2.get(n), c = v2[0], y2 = v2[1], N = v2[2], O2 = v2[3], g2 = Ne(e), u = g2[0], q2 = g2[1], U = g2[2], T2 = (0, import_react2.useRef)(false), E = (0, import_react2.useRef)(false), D = (0, import_react2.useRef)(u), P2 = (0, import_react2.useRef)(i), V2 = (0, import_react2.useRef)(t), m = function() {
        return V2.current;
      }, oe2 = function() {
        return m().isVisible() && m().isOnline();
      }, re2 = function(R2) {
        return n.set(U, S2(n.get(U), R2));
      }, Ee = n.get(u), Qe = b2(r) ? t.fallback[u] : r, I2 = b2(Ee) ? Qe : Ee, we = n.get(U) || {}, j2 = we.error, Le2 = !T2.current, Me2 = function() {
        return Le2 && !b2(f) ? f : m().isPaused() ? false : o ? b2(I2) ? false : t.revalidateIfStale : b2(I2) || t.revalidateIfStale;
      }, Xe = function() {
        return !u || !i ? false : we.isValidating ? true : Le2 && Me2();
      }, se2 = Xe(), ue2 = xt({ data: I2, error: j2, isValidating: se2 }, E), K2 = ue2[0], fe2 = ue2[1], ne2 = ue2[2], F2 = (0, import_react2.useCallback)(function(R2) {
        return Fe2(void 0, void 0, void 0, function() {
          var z2, C2, x2, J2, Y2, w2, p, A2, L2, le2, B2, $2, ce2;
          return We2(this, function(Z2) {
            switch (Z2.label) {
              case 0:
                if (z2 = P2.current, !u || !z2 || E.current || m().isPaused())
                  return [2, false];
                J2 = true, Y2 = R2 || {}, w2 = !O2[u] || !Y2.dedupe, p = function() {
                  return !E.current && u === D.current && T2.current;
                }, A2 = function() {
                  var Te = O2[u];
                  Te && Te[1] === x2 && delete O2[u];
                }, L2 = { isValidating: false }, le2 = function() {
                  re2({ isValidating: false }), p() && ne2(L2);
                }, re2({ isValidating: true }), ne2({ isValidating: true }), Z2.label = 1;
              case 1:
                return Z2.trys.push([1, 3, , 4]), w2 && (ee2(n, u, K2.current.data, K2.current.error, true), t.loadingTimeout && !n.get(u) && setTimeout(function() {
                  J2 && p() && m().onLoadingSlow(u, t);
                }, t.loadingTimeout), O2[u] = [z2.apply(void 0, q2), Oe2()]), ce2 = O2[u], C2 = ce2[0], x2 = ce2[1], [4, C2];
              case 2:
                return C2 = Z2.sent(), w2 && setTimeout(A2, t.dedupingInterval), !O2[u] || O2[u][1] !== x2 ? (w2 && p() && m().onDiscarded(u), [2, false]) : (re2({ error: h2 }), L2.error = h2, B2 = N[u], !b2(B2) && (x2 <= B2[0] || x2 <= B2[1] || B2[1] === 0) ? (le2(), w2 && p() && m().onDiscarded(u), [2, false]) : (a(K2.current.data, C2) ? L2.data = K2.current.data : L2.data = C2, a(n.get(u), C2) || n.set(u, C2), w2 && p() && m().onSuccess(C2, u, t), [3, 4]));
              case 3:
                return $2 = Z2.sent(), A2(), m().isPaused() || (re2({ error: $2 }), L2.error = $2, w2 && p() && (m().onError($2, u, t), (typeof t.shouldRetryOnError == "boolean" && t.shouldRetryOnError || k2(t.shouldRetryOnError) && t.shouldRetryOnError($2)) && oe2() && m().onErrorRetry($2, u, t, F2, { retryCount: (Y2.retryCount || 0) + 1, dedupe: true }))), [3, 4];
              case 4:
                return J2 = false, le2(), p() && w2 && ee2(n, u, L2.data, L2.error, false), [2, true];
            }
          });
        });
      }, [u]), et2 = (0, import_react2.useCallback)(Ge2.bind(h2, n, function() {
        return D.current;
      }), []);
      if (X2(function() {
        P2.current = i, V2.current = t;
      }), X2(function() {
        if (!!u) {
          var R2 = u !== D.current, z2 = F2.bind(h2, ge), C2 = function(p, A2, L2) {
            ne2(S2({ error: A2, isValidating: L2 }, a(K2.current.data, p) ? h2 : { data: p }));
          }, x2 = 0, J2 = function(p) {
            if (p == Ke) {
              var A2 = Date.now();
              m().revalidateOnFocus && A2 > x2 && oe2() && (x2 = A2 + m().focusThrottleInterval, z2());
            } else if (p == $e)
              m().revalidateOnReconnect && oe2() && z2();
            else if (p == He)
              return F2();
          }, Y2 = Ue2(u, y2, C2), w2 = Ue2(u, c, J2);
          return E.current = false, D.current = u, T2.current = true, R2 && ne2({ data: I2, error: j2, isValidating: se2 }), Me2() && (b2(I2) || ae2 ? z2() : Ot(z2)), function() {
            E.current = true, Y2(), w2();
          };
        }
      }, [u, F2]), X2(function() {
        var R2;
        ...
        function C2() {
          !K2.current.error && (s || m().isVisible()) && (l || m().isOnline()) ? F2(ge).then(z2) : z2();
        }
        return z2(), function() {
          R2 && (clearTimeout(R2), R2 = -1);
        };
      }, [d, s, l, F2]), (0, import_react2.useDebugValue)(I2), o && b2(I2) && u)
        throw P2.current = i, V2.current = t, E.current = false, b2(j2) ? F2(ge) : j2;
      return { mutate: et2, get data() {
        return fe2.data = true, I2;
      }, get error() {
    ...
    Pr = Q2.defineProperty(Rt, "default", { value: Ye });
    xe = Lt(Mt);
    Dr = (e) => {
      let { invitationList: i, membershipList: t } = e || {}, { organization: n, lastOrganizationMember: a, lastOrganizationInvitation: r } = Pe2(), o = Se2(), f = G(), d = f.loaded && o && n, s = f.loaded ? () => f.organization?.getPendingInvitations(i) : () => [], l = f.loaded ? () => f.organization?.getMemberships(t) : () => [], { data: v2, isValidating: c, mutate: y2 } = xe(d && i ? Ze2("invites", n, r, i) : null, s), { data: N, isValidating: O2, mutate: g2 } = xe(d && t ? Ze2("memberships", n, a, t) : null, l);
      return n === void 0 ? { isLoaded: false, organization: void 0, invitationList: void 0, membershipList: void 0, membership: void 0 } : n === null ? { isLoaded: true, organization: null, invitationList: null, membershipList: null, membership: null } : !f.loaded && n ? { isLoaded: true, organization: n, invitationList: void 0, membershipList: void 0, membership: void 0 } : { isLoaded: !O2 && !c, organization: n, membershipList: N, membership: Tt(o.user.organizationMemberships, n.id), invitationList: v2, unstable__mutate: () => {
        g2(), y2();
      } };
    };
    Wr = () => {
...
//# sourceMappingURL=/build/_shared/chunk-D5EZEAYJ.js.map
